# Desktop: autorandr + i3/xfce setup
# Enabled via: features.desktop.autorandr.enable = true;
# Note: This also configures i3 and xfce as they're tightly coupled
{ lib, config, pkgs, ... }:
...
in
{
  config = lib.mkIf cfg.autorandr.enable {
